...
def update_user(user, chat_id):
    ...
    try:
        with db_connection() as cursor:
            ...
            # Log user activity
            track_user_activity(
                user.id, "bot_interaction", {"chat_id": chat_id}
            )
...
def get_user_stats(user_id: int) -> Dict:
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "get_user_stats", "user_id": user_id}
        )
        return {}


def track_user_activity(
    user_id: int, activity_type: str, activity_data: Dict = None
):
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "track_user_activity", "user_id": user_id}
        )
...
def track_lesson_completion(
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "track_lesson_completion", "user_id": user_id}
        )
...
def create_price_alert(
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "create_price_alert", "user_id": user_id}
        )
        return None
...
def trigger_price_alert(alert_id: int):
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "trigger_price_alert", "alert_id": alert_id}
        )
...
def get_user_by_id(user_id):
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "get_user_by_id", "user_id": user_id}
        )
        return None
...
def update_last_tip(user_id):
    ...
    try:
        ...
        logger.log_error(
            e, {"operation": "update_last_tip", "user_id": user_id}
        )


def save_feedback(
    user_id, username, feedback_text, feedback_type="general", rating=None
):
...
class DatabaseManager:
    ...
    def update_user_activity(self, user_id: int):
        ...
        try:
            ...
            logger.log_error(
                e, {"operation": "update_user_activity", "user_id": user_id}
            )
            ...
            with db_connection() as cursor:
                ...
                return {
                    ...
                    "total_lessons_completed": (
                        user_stats[0] if user_stats else 0
                    ),
    ...
    def save_lesson_progress(
        self, user_id: int, lesson_key: str, completion_time: int = None
    ):
