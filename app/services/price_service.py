...
class BitcoinPriceMonitor:
                ...
                try:
                    async with session.get(
                        ...
                        if response.status == 200:
                            ...
                            kes_price = usd_price * 129  # Approximate USD to KES
    ...
    async def send_price_alert(self, bot, alert: Dict, current_price: float):
        ...
        try:
            ...
            condition_text = 'juu ya' if alert['condition'] == 'above' else 'chini ya'
    ...
    def get_price_trend(self, hours: int = 24) -> Dict:
        ...
        try:
            ...
            trend = 'bullish' if change_percent > 2 else 'bearish' if change_percent < -2 else 'sideways'
...
async def get_enhanced_bitcoin_price():
    ...
    try:
        ...
        trend_emoji = {
            ...
            'bearish': '📉',
            'sideways': '➡️'
        }.get(trend_data.get('trend', 'sideways'), '➡️')
