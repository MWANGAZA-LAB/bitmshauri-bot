...
class RateLimiter:
    ...
    def is_rate_limited(self, user_id: int, action_type: str = 'message') -> bool:
        ...
        if self.user_penalties[user_id] > current_time:
            logger.log_user_action(user_id, 'rate_limit_blocked', {
    ...
    def _cleanup_old_requests(self, user_id: int, current_time: float):
        ...
        while (self.global_requests and 
               self.global_requests[0] < global_cutoff):
    ...
    def _apply_penalty(self, user_id: int, action_type: str):
        ...
        logger.log_user_action(user_id, 'rate_limit_violation', {
            'action_type': action_type,
    ...
    def get_user_status(self, user_id: int) -> Dict:
        ...
        return {
            ...
            'limits': {
                ...
                'audio_requests_per_hour': self.LIMITS['audio_requests_per_hour']
            }
        }
