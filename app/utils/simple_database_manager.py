...
class SimpleDatabaseManager:
    ...
    async def add_user(self, user_id: int, username: str = None, 
        ...
        try:
            if ASYNC_SQLITE_AVAILABLE:
                await self._add_user_async(user_id, username, first_name, last_name, chat_id)
            else:
                await self._add_user_sync(user_id, username, first_name, last_name, chat_id)
        except Exception as e:
            logger.log_error(e, {"operation": "add_user", "user_id": user_id})
    
    async def _add_user_async(self, user_id: int, username: str = None, 
                             first_name: str = None, last_name: str = None, 
                             chat_id: int = None):
    ...
    async def _add_user_sync(self, user_id: int, username: str = None, 
                            first_name: str = None, last_name: str = None, 
                            chat_id: int = None):
    ...
    async def _save_lesson_progress_async(self, user_id: int, lesson_key: str):
    ...
    async def _save_lesson_progress_sync(self, user_id: int, lesson_key: str):
    ...
    async def save_quiz_result(self, user_id: int, quiz_name: str, score: int, 
                              total_questions: int, answers: List, time_taken: int):
        """Save quiz result"""
        try:
            answers_json = json.dumps(answers)
            if ASYNC_SQLITE_AVAILABLE:
                await self._save_quiz_result_async(user_id, quiz_name, score, total_questions, answers_json, time_taken)
            else:
                await self._save_quiz_result_sync(user_id, quiz_name, score, total_questions, answers_json, time_taken)
        except Exception as e:
            logger.log_error(e, {"operation": "save_quiz_result", "user_id": user_id})
    
    async def _save_quiz_result_async(self, user_id: int, quiz_name: str, score: int, 
                                     total_questions: int, answers_json: str, time_taken: int):
    ...
    async def _save_quiz_result_sync(self, user_id: int, quiz_name: str, score: int, 
                                    total_questions: int, answers_json: str, time_taken: int):
    ...
    async def save_feedback(self, user_id: int, feedback_text: str):
        """Save user feedback"""
        try:
            if ASYNC_SQLITE_AVAILABLE:
    ...
    async def _save_feedback_async(self, user_id: int, feedback_text: str):
    ...
    async def _save_feedback_sync(self, user_id: int, feedback_text: str):
