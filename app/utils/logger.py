...
class StructuredLogger:
    ...
    def log_error(self, error: Exception, context: Optional[Dict] = None, user_id: Optional[int] = None):
    ...
    def log_performance(self, function_name: str, duration: float, user_id: Optional[int] = None):
